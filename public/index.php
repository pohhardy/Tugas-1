...
<body class="page-index">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <h1 class="d-flex align-items-center">Hardy</h1>
      </a>
  ...
  <section id="hero" class="hero d-flex align-items-center">
    <div class="container">
      <div class="row">
        <div class="col-xl-4">
          <h2 data-aos="fade-up">03081200035</h2>
          <blockquote data-aos="fade-up" data-aos-delay="100">
            <p>Saya merupakan mahasiswa Universitas Pelita Harapan Medan di Fakultas Ilmu Komputer Program Studi Sistem Informasi .Saya senang mengotak atik komputer, mengedit gambar serta video dan kegiatan yang berhubungan dengan komputer.
            </p>
          </blockquote>
